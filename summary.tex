...
Un'attivit0a decomposta permette di agevolare il parallelismo. Il WBS 
serve ad avere una percezione
delle attivita ni (foglie) da svolgere. Allocazione delle risorse: assegnare 
attivita a ruoli e poi ruoli a persone
per far si che ogni persona sia impegnata per tutto il tempo disponibile. 
Diagramma di Gantt ribaltato sulle
persone (al posto delle attivita); l'intento e sapere che sto usando le 
persone in parallelo ed entro il limite
dato. La decisione delle ore di investimento per la formazione personale e a 
discrezione di ciascuno. La
componente informatica moderna e basata sull'apprendimento di tecnologie 
nuove. Fattori di in
uenza:
- Dimensione del progetto -> quante righe di codice mi servono; nel nostro 
progetto stara tra 5000-10000
righe, nello stage circa 2000 (si intende righe produttive). La dimensione si 
riesce a stimare macroscopica-
1
mente; sta tra due assi: quanto codice e quanto complesso.
- Esperienza del dominio -> quanta e l'esperienza di chi svolge il progetto 
nei confronti del dominio a cui
siamo davanti.
- Tecnologie adottate -> in
uenza molto forte, e una scelta strategica di 
amministrazione.
- Ambiente di sviluppo -> procedure e tecniche con le quali collaboriamo, 
dobbiamo collocale a basso
costo temporale.
- Qualita di richiesta.
Problematiche di stima
Legge di Parkinson -> il lavoro si espande no a riempire il tempo disponibile.
Legge della domanda -> quanto piu e basso il prezzo di una cosa tanto piu 
grande sara la domanda per quella
cosa l. Uso in abbondanza le cose che costano poco.
